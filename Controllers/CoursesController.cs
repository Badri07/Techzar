...
namespace Techzar.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(PostgresContext context)
        {
            _context = context;
        }
        ...
        {
            var postgresContext = _context.Courses.Include(c => c.Department);
        ...
        public async Task<IActionResult> Create([Bind("Courseid,Coursename,Departmentid")] Course course)
        {
